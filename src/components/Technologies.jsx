...
const Technologies = () => {
  return (
    ...
    <div className='text-gray-800 text-center'>
        <div className='text-4xl p-10 sm:text-3xl sm:p-6'>Technologies</div>
        <div className='flex gap-20 justify-center sm:flex-col sm:gap-10 sm:items-center'>
        ...
        <div className='text-4xl p-10 sm:text-3xl sm:p-6'>Frameworks</div>
        <div className='flex gap-20 justify-center sm:flex-col sm:gap-10 sm:items-center'>
